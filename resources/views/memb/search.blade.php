        ...
        <div class="section1">
            ...
            <div class="product">
                {{-- <div class="search-bar">
                    ...
                    <iconify-icon icon="material-symbols:search" style="color: saddlebrown;" width="32" height="32"></iconify-icon>
                </div> --}}
                <x-searchBar/>
                <div class="cards-container">
                    @php
                        $title = "Aerostreet Osaka Krem Biru Hitam";
                        $price = "149.900";
                        $stars = 4.7;
                    @endphp
                    @for ($i = 1; $i <= 12; $i++)
                    <a href="{{route('mproduct')}}"><x-shoesCard :$title :$price :$stars/></a>
                    @endfor
                </div>
                <div class="paginator">
